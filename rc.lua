...
-- random wallpaper
os.execute("~/.config/awesome/wallpaper.sh&")
...
--vicious.register(volwidget, vicious.widgets.volume, "Vol: $1", 5, "Master")

-- Battery state Widget
mybatwidget = widget({ type = "textbox" })
vicious.register(mybatwidget, vicious.widgets.bat, "Battery: $1 $2% ($3 Remaining)", 61, "BAT0")
